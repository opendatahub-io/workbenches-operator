...
var imageParamMap = map[string]string{
	...
	// Workspaces controller (uncomment when workspaces-controller manifests are available)
	// "workspaces-controller-image": "RELATED_IMAGE_WORKSPACES_CONTROLLER_IMAGE",
}
